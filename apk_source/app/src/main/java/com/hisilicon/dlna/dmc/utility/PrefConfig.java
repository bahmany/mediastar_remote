...
public class PrefConfig {
    ...
    public static SharedPreferences getSharedPreferences(String sharedPreferences) {
        return HiMultiscreen.getApplication().getSharedPreferences(sharedPreferences, 0);
    }

    public static SharedPreferences getDefaultSharedPreferences() {
        return PreferenceManager.getDefaultSharedPreferences(HiMultiscreen.getApplication());
    }
