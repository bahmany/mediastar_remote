...
public class DataMap {
    ...
    public static DataMap fromByteArray(byte[] bytes) {
        try {
            return pb.a(new pb.a(pc.n(bytes), new ArrayList()));
        } catch (pl e) {
    ...
    public void putAll(DataMap dataMap) {
        for (String str : dataMap.keySet()) {
            this.auL.put(str, dataMap.get(str));
        }
    }
    ...
    public Bundle toBundle() {
        ...
        for (String str : this.auL.keySet()) {
            a(bundle, str, this.auL.get(str));
        }
        return bundle;
    }
