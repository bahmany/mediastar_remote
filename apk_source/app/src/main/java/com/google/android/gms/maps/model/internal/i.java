...
public interface i extends IInterface {
    ...
    public static abstract class a extends Binder implements i {
        ...
        private static class C0136a implements i {
            private IBinder lb;
        ...
        public static i by(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof i)) ? new C0136a(iBinder) : (i) iInterfaceQueryLocalInterface;
        }
