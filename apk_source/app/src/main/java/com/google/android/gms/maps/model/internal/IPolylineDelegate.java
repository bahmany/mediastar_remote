...
public interface IPolylineDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements IPolylineDelegate {
        ...
        private static class C0126a implements IPolylineDelegate {
            private IBinder lb;
        ...
        public static IPolylineDelegate bw(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IPolylineDelegate)) ? new C0126a(iBinder) : (IPolylineDelegate) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 15:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    boolean zEqualsRemote = equalsRemote(bw(parcel.readStrongBinder()));
                    parcel2.writeNoException();
