...
public interface i extends IInterface {
    ...
    public static abstract class a extends Binder implements i {
        ...
        private static class C0007a implements i {
            private IBinder lb;
        ...
        public static i O(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof i)) ? new C0007a(iBinder) : (i) iInterfaceQueryLocalInterface;
        }
