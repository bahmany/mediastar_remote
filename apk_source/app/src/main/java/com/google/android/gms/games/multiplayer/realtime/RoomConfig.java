...
public final class RoomConfig {
    ...
    public static final class Builder {
        ...
        private Builder(RoomUpdateListener updateListener) {
            ...
            this.aci = false;
            this.acd = (RoomUpdateListener) n.b(updateListener, "Must provide a RoomUpdateListener");
        }
        ...
        public Builder setVariant(int variant) {
            n.b(variant == -1 || variant > 0, "Variant must be a positive integer or Room.ROOM_VARIANT_ANY");
            this.abS = variant;
            return this;
        }
    }
