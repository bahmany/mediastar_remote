...
public interface bd extends IInterface {
    ...
    public static abstract class a extends Binder implements bd {
        ...
        private static class C0037a implements bd {
            private IBinder lb;
            ...
            public com.google.android.gms.dynamic.d X() throws RemoteException {
            ...
            public ay Y() throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain2.readException();
                    return parcelObtain2.readInt() != 0 ? ay.CREATOR.createFromParcel(parcelObtain2) : null;
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
                }
            ...
            public void a(bf bfVar) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdManager");
                    parcelObtain.writeStrongBinder(bfVar != null ? bfVar.asBinder() : null);
            ...
            public void a(eh ehVar) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdManager");
                    parcelObtain.writeStrongBinder(ehVar != null ? ehVar.asBinder() : null);
            ...
            @Override // com.google.android.gms.internal.bd
            public void a(el elVar, String str) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdManager");
                    parcelObtain.writeStrongBinder(elVar != null ? elVar.asBinder() : null);
            ...
            @Override // com.google.android.gms.internal.bd
            public void a(et etVar) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdManager");
                    parcelObtain.writeStrongBinder(etVar != null ? etVar.asBinder() : null);
            ...
            public void a(eu euVar) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdManager");
                    parcelObtain.writeStrongBinder(euVar != null ? euVar.asBinder() : null);
        ...
        public static bd f(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof bd)) ? new C0037a(iBinder) : (bd) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    com.google.android.gms.dynamic.d dVarX = X();
                    parcel2.writeNoException();
                    parcel2.writeStrongBinder(dVarX != null ? dVarX.asBinder() : null);
                    return true;
                case 2:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IAdManager");
                    destroy();
                ...
                case 4:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IAdManager");
                    boolean zA = a(parcel.readInt() != 0 ? av.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                ...
                case 12:
                    ...
                    parcel2.writeInt(1);
                    ayVarY.writeToParcel(parcel2, 1);
                    return true;
                case 13:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IAdManager");
                    a(parcel.readInt() != 0 ? ay.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 14:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IAdManager");
    ...
    void a(eh ehVar) throws RemoteException;

    void a(el elVar, String str) throws RemoteException;

    void a(et etVar) throws RemoteException;
