...
public interface q extends IInterface {
    ...
    public static abstract class a extends Binder implements q {
        ...
        private static class C0123a implements q {
            private IBinder lb;
        ...
        public static q bh(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof q)) ? new C0123a(iBinder) : (q) iInterfaceQueryLocalInterface;
        }
