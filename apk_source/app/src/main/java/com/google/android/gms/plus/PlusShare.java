...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Builder(Activity launchingActivity, PlusClient plusClient) {
            ...
            n.a(plusClient != null, "PlusClient must not be null.");
            n.a(plusClient.isConnected(), "PlusClient must be connected to create an interactive post.");
            n.a(plusClient.mX().cd(Scopes.PLUS_LOGIN), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
        ...
        public Builder addCallToAction(String label, Uri uri, String deepLinkId) {
            ...
            n.b((uri == null || TextUtils.isEmpty(uri.toString())) ? false : true, "Must provide a call to action URL");
            ...
            if (!TextUtils.isEmpty(deepLinkId)) {
                n.a(PlusShare.ca(deepLinkId), "The specified deep-link ID was malformed.");
            ...
            this.mIntent.setType(HttpServer.MIME_PLAINTEXT);
            return this;
        }
        ...
        public Intent getIntent() {
            ...
            n.a((z2 && booleanExtra) ? false : true, "Call-to-action buttons are only available for URLs.");
            n.a(!booleanExtra || this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL), "The content URL is required for interactive posts.");
            ...
            n.a(z, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)) {
                n.a(PlusShare.ca(this.mIntent.getStringExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)), "The specified deep-link ID was malformed.");
            }
            if (!z2 && zEquals) {
        ...
        public Builder setContentDeepLinkId(String deepLinkId, String title, String description, Uri thumbnailUri) {
            ...
            n.b(!TextUtils.isEmpty(deepLinkId), "The deepLinkId parameter is required.");
    ...
    protected static boolean ca(String str) {
    ...
    public static Person createPerson(String id, String displayName) {
        ...
        return new ny(displayName, id, null, 0, null);
    }
