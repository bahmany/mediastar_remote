...
public interface ct extends IInterface {
    ...
    public static abstract class a extends Binder implements ct {

        /* renamed from: com.google.android.gms.internal.ct$a$a, reason: collision with other inner class name */
        private static class C0042a implements ct {
            private IBinder lb;
            ...
            public cu x(String str) throws RemoteException {
                ...
                try {
                    ...
                    return cu.a.m(parcelObtain2.readStrongBinder());
                } finally {
        ...
        public static ct l(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ct)) ? new C0042a(iBinder) : (ct) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    cu cuVarX = x(data.readString());
                    reply.writeNoException();
                    reply.writeStrongBinder(cuVarX != null ? cuVarX.asBinder() : null);
                    return true;
                case 2:
                    data.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IAdapterCreator");
                    boolean zY = y(data.readString());
                    reply.writeNoException();
                    reply.writeInt(zY ? 1 : 0);
                    return true;
                case 1598968902:
    ...
    cu x(String str) throws RemoteException;
