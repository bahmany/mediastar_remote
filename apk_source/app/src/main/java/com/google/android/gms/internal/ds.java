...
public interface ds extends IInterface {
    ...
    public static abstract class a extends Binder implements ds {
        ...
        /* renamed from: com.google.android.gms.internal.ds$a$a, reason: collision with other inner class name */
        private static class C0045a implements ds {
            private IBinder lb;
        ...
        public static ds p(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ds)) ? new C0045a(iBinder) : (ds) iInterfaceQueryLocalInterface;
        }
