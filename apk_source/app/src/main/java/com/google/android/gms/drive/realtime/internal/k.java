...
public interface k extends IInterface {
    ...
    public static abstract class a extends Binder implements k {
        ...
        private static class C0024a implements k {
            private IBinder lb;
        ...
        public static k ag(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof k)) ? new C0024a(iBinder) : (k) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    a(parcel.readInt() != 0 ? ParcelableIndexReference.CREATOR.createFromParcel(parcel) : null);
