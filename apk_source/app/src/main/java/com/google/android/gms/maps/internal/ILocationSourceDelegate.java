...
public interface ILocationSourceDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements ILocationSourceDelegate {
        ...
        private static class C0100a implements ILocationSourceDelegate {
            private IBinder lb;
        ...
        public static ILocationSourceDelegate aS(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ILocationSourceDelegate)) ? new C0100a(iBinder) : (ILocationSourceDelegate) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    activate(h.a.aY(data.readStrongBinder()));
