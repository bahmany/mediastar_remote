...
public interface lm extends IInterface {
    ...
    public static abstract class a extends Binder implements lm {
        ...
        private static class C0076a implements lm {
            private IBinder lb;
        ...
        public static lm aG(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof lm)) ? new C0076a(iBinder) : (lm) iInterfaceQueryLocalInterface;
        }
