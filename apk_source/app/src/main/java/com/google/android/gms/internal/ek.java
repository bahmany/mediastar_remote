...
public interface ek extends IInterface {
    ...
    public static abstract class a extends Binder implements ek {
        ...
        /* renamed from: com.google.android.gms.internal.ek$a$a, reason: collision with other inner class name */
        private static class C0051a implements ek {
            private IBinder lb;
        ...
        public static ek w(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ek)) ? new C0051a(iBinder) : (ek) iInterfaceQueryLocalInterface;
        }
