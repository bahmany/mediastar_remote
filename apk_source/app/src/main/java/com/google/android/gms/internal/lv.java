...
public interface lv extends IInterface {
    ...
    public static abstract class a extends Binder implements lv {

        /* renamed from: com.google.android.gms.internal.lv$a$a, reason: collision with other inner class name */
        private static class C0079a implements lv {
            private IBinder lb;
        ...
        public static lv aJ(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof lv)) ? new C0079a(iBinder) : (lv) iInterfaceQueryLocalInterface;
        }
