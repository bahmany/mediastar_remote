...
public interface s extends IInterface {
    ...
    public static abstract class a extends Binder implements s {
        ...
        private static class C0125a implements s {
            private IBinder lb;
        ...
        public static s bk(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof s)) ? new C0125a(iBinder) : (s) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.ISnapshotReadyCallback");
                    h(d.a.am(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
