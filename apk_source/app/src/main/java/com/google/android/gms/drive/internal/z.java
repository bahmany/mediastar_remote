...
public class z implements Parcelable.Creator<GetDriveIdFromUniqueIdentifierRequest> {
    static void a(GetDriveIdFromUniqueIdentifierRequest getDriveIdFromUniqueIdentifierRequest, Parcel parcel, int i) {
        ...
        com.google.android.gms.common.internal.safeparcel.b.c(parcel, 1, getDriveIdFromUniqueIdentifierRequest.BR);
        com.google.android.gms.common.internal.safeparcel.b.a(parcel, 2, getDriveIdFromUniqueIdentifierRequest.OZ, false);
        com.google.android.gms.common.internal.safeparcel.b.a(parcel, 3, getDriveIdFromUniqueIdentifierRequest.Pa);
    ...
    public GetDriveIdFromUniqueIdentifierRequest createFromParcel(Parcel parcel) {
        ...
        return new GetDriveIdFromUniqueIdentifierRequest(iG, strO, zC);
    }
