...
public final class VisibleRegion implements SafeParcelable {
    ...
    public int hashCode() {
        return com.google.android.gms.common.internal.m.hashCode(this.nearLeft, this.nearRight, this.farLeft, this.farRight, this.latLngBounds);
    }

    public String toString() {
        return com.google.android.gms.common.internal.m.h(this).a("nearLeft", this.nearLeft).a("nearRight", this.nearRight).a("farLeft", this.farLeft).a("farRight", this.farRight).a("latLngBounds", this.latLngBounds).toString();
    }
