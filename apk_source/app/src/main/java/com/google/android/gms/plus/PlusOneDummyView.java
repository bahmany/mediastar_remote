...
public class PlusOneDummyView extends FrameLayout {
    ...
    public PlusOneDummyView(Context context, int size) {
        ...
        button.setBackgroundDrawable(mY().getDrawable(size));
        Point pointEP = eP(size);
        addView(button, new FrameLayout.LayoutParams(pointEP.x, pointEP.y, 17));
    }

    private Point eP(int i) {
        int i2 = 24;
        int i3 = 20;
