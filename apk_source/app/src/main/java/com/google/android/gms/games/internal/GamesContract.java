...
public final class GamesContract {
    ...
    public interface AchievementDefinitionsColumns {
        public static final String[] XK = {"game_id", "external_achievement_id", PlaylistSQLiteHelper.COL_TYPE, "name", PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_DESCRIPTION, "unlocked_icon_image_id", "unlocked_icon_image_uri", "unlocked_icon_image_url", "revealed_icon_image_id", "revealed_icon_image_uri", "revealed_icon_image_url", "total_steps", "formatted_total_steps", "initial_state", "sorting_rank", "definition_xp_value"};
    }
    ...
    public interface EventDefinitionColumns {
        public static final String[] XK = {"event_definitions_game_id", "external_event_id", "name", PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_DESCRIPTION, "visibility", "icon_image_id", "icon_image_uri", "icon_image_url", "sorting_rank"};
    }
    ...
    public interface ExperienceEventColumns {
        public static final String[] XK = {"external_experience_id", "game_id", "created_timestamp", "current_xp", "xp_earned", "display_title", "display_description", "display_string", PlaylistSQLiteHelper.COL_TYPE, "icon_id", "icon_url", "icon_uri", "newLevel"};
    }
    ...
    public interface ImagesColumns {
        public static final String[] XK = {"url", SpeechConstant.TYPE_LOCAL, "filesize", "download_timestamp"};
    }

    public interface InvitationsColumns {
        public static final String[] XK = {"game_id", "external_invitation_id", "external_inviter_id", "creation_timestamp", "last_modified_timestamp", PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_DESCRIPTION, PlaylistSQLiteHelper.COL_TYPE, "variant", "has_automatch_criteria", "automatch_min_players", "automatch_max_players", "inviter_in_circles"};
    }
    ...
    public interface MatchesPendingOpsColumns {
        public static final String[] XK = {"client_context_id", PlaylistSQLiteHelper.COL_TYPE, "external_game_id", "external_match_id", "pending_participant_id", "version", "is_turn", "results"};
    }
    ...
    public interface NotificationsColumns {
        public static final String[] XK = {"notification_id", "game_id", "external_sub_id", PlaylistSQLiteHelper.COL_TYPE, "image_id", "ticker", "title", "text", "coalesced_text", "timestamp", "acknowledged", "alert_level"};
    }
    ...
    public interface ParticipantsColumns {
        public static final String[] XK = {"match_id", "invitation_id", "external_participant_id", "player_id", "default_display_image_id", "default_display_image_url", "default_display_hi_res_image_id", "default_display_hi_res_image_url", "default_display_name", "player_status", "client_address", SpeechConstant.RESULT_TYPE, "placing", "connected", "capabilities"};
    }
    ...
    public interface RequestsColumns {
        public static final String[] XK = {"external_request_id", "game_id", "sender_id", "data", PlaylistSQLiteHelper.COL_TYPE, "creation_timestamp", "expiration_timestamp", "status"};
    }

    public interface SnapshotColumns {
        public static final String[] XK = {"game_id", "owner_id", "external_snapshot_id", "drive_resolved_id_string", "drive_resource_id_string", "cover_icon_image_id", "cover_icon_image_uri", "cover_icon_image_url", "cover_icon_image_width", "cover_icon_image_height", "title", PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_DESCRIPTION, "last_modified_timestamp", "duration", "unique_name", "visible"};
    }
}
