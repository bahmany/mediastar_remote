...
public interface na extends IInterface {
    ...
    public static abstract class a extends Binder implements na {
        ...
        private static class C0083a implements na {
            private IBinder lb;
            ...
            public void a(mz mzVar, Uri uri, Bundle bundle, boolean z) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken("com.google.android.gms.panorama.internal.IPanoramaService");
                    parcelObtain.writeStrongBinder(mzVar != null ? mzVar.asBinder() : null);
                    if (uri != null) {
        ...
        public static na bA(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof na)) ? new C0083a(iBinder) : (na) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    a(mz.a.bz(data.readStrongBinder()), data.readInt() != 0 ? (Uri) Uri.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, data.readInt() != 0);
                    return true;
                case 1598968902:
    ...
    void a(mz mzVar, Uri uri, Bundle bundle, boolean z) throws RemoteException;
}
