...
public final class CastMediaControlIntent {
    ...
    private static String a(String str, String str2, Collection<String> collection) throws IllegalArgumentException {
        ...
        if (str2 != null) {
            ...
            stringBuffer.append(ServiceReference.DELIMITER).append(upperCase);
        }
        if (collection != null) {
            ...
            stringBuffer.append(ServiceReference.DELIMITER).append(TextUtils.join(ClientInfo.SEPARATOR_BETWEEN_VARS, collection));
        }
