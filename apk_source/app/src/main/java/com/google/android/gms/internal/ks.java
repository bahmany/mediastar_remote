...
public interface ks extends IInterface {
    ...
    public static abstract class a extends Binder implements ks {
        ...
        private static class C0073a implements ks {
            private IBinder lb;
        ...
        public static ks aw(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ks)) ? new C0073a(iBinder) : (ks) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    k(data.readInt() != 0 ? Status.CREATOR.createFromParcel(data) : null);
