...
public interface IProjectionDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements IProjectionDelegate {
        ...
        private static class C0103a implements IProjectionDelegate {
            private IBinder lb;
        ...
        public static IProjectionDelegate bj(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IProjectionDelegate)) ? new C0103a(iBinder) : (IProjectionDelegate) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    LatLng latLngFromScreenLocation = fromScreenLocation(d.a.am(data.readStrongBinder()));
