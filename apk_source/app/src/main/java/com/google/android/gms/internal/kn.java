...
public interface kn extends IInterface {
    ...
    public static abstract class a extends Binder implements kn {

        /* renamed from: com.google.android.gms.internal.kn$a$a, reason: collision with other inner class name */
        private static class C0068a implements kn {
            private IBinder lb;
        ...
        public static kn ar(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof kn)) ? new C0068a(iBinder) : (kn) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    a(data.readInt() != 0 ? DataTypeResult.CREATOR.createFromParcel(data) : null);
