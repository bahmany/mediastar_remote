...
public class FitnessActivities {
    ...
    private static final SparseArray<String> Sg = new SparseArray<>(KeyInfo.KEYCODE_NEXT);
    ...
    static {
        Sg.put(9, AEROBICS_STRING);
        Sg.put(10, BADMINTON_STRING);
        Sg.put(11, BASEBALL_STRING);
        Sg.put(12, BASKETBALL_STRING);
        Sg.put(13, BIATHLON_STRING);
        Sg.put(1, BIKING_STRING);
        Sg.put(14, BIKING_HAND_STRING);
        Sg.put(15, BIKING_MOUNTAIN_STRING);
        Sg.put(16, BIKING_ROAD_STRING);
        Sg.put(17, BIKING_SPINNING_STRING);
        Sg.put(18, BIKING_STATIONARY_STRING);
        Sg.put(19, BIKING_UTILITY_STRING);
        Sg.put(20, BOXING_STRING);
        Sg.put(21, CALISTHENICS_STRING);
        Sg.put(22, CIRCUIT_TRAINING_STRING);
        Sg.put(23, CRICKET_STRING);
        Sg.put(106, CURLING_STRING);
        Sg.put(24, DANCING_STRING);
        Sg.put(102, DIVING_STRING);
        Sg.put(25, ELLIPTICAL_STRING);
        Sg.put(103, ERGOMETER_STRING);
        Sg.put(6, EXITING_VEHICLE_STRING);
        Sg.put(26, FENCING_STRING);
        Sg.put(27, FOOTBALL_AMERICAN_STRING);
        Sg.put(28, FOOTBALL_AUSTRALIAN_STRING);
        Sg.put(29, FOOTBALL_SOCCER_STRING);
        Sg.put(30, FRISBEE_DISC_STRING);
        Sg.put(31, GARDENING_STRING);
        Sg.put(32, GOLF_STRING);
        Sg.put(33, GYMNASTICS_STRING);
        Sg.put(34, HANDBALL_STRING);
        Sg.put(35, HIKING_STRING);
        Sg.put(36, HOCKEY_STRING);
        Sg.put(37, HORSEBACK_RIDING_STRING);
        Sg.put(38, HOUSEWORK_STRING);
        Sg.put(104, ICE_SKATING_STRING);
        Sg.put(0, IN_VEHICLE_STRING);
        Sg.put(39, JUMP_ROPE_STRING);
        Sg.put(40, KAYAKING_STRING);
        Sg.put(41, KETTLEBELL_TRAINING_STRING);
        Sg.put(KICK_SCOOTER, KICK_SCOOTER_STRING);
        Sg.put(42, KICKBOXING_STRING);
        Sg.put(43, KITESURFING_STRING);
        Sg.put(44, MARTIAL_ARTS_STRING);
        Sg.put(45, MEDITATION_STRING);
        Sg.put(46, MIXED_MARTIAL_ARTS_STRING);
        Sg.put(2, ON_FOOT_STRING);
        Sg.put(108, OTHER_STRING);
        Sg.put(47, P90X_STRING);
        Sg.put(48, PARAGLIDING_STRING);
        Sg.put(49, PILATES_STRING);
        Sg.put(50, POLO_STRING);
        Sg.put(51, RACQUETBALL_STRING);
        Sg.put(52, ROCK_CLIMBING_STRING);
        Sg.put(53, ROWING_STRING);
        Sg.put(54, ROWING_MACHINE_STRING);
        Sg.put(55, RUGBY_STRING);
        Sg.put(8, RUNNING_STRING);
        Sg.put(56, RUNNING_JOGGING_STRING);
        Sg.put(57, RUNNING_SAND_STRING);
        Sg.put(58, RUNNING_TREADMILL_STRING);
        Sg.put(59, SAILING_STRING);
        Sg.put(60, SCUBA_DIVING_STRING);
        Sg.put(61, SKATEBOARDING_STRING);
        Sg.put(62, SKATING_STRING);
        Sg.put(63, SKATING_CROSS_STRING);
        Sg.put(105, SKATING_INDOOR_STRING);
        Sg.put(64, SKATING_INLINE_STRING);
        Sg.put(65, SKIING_STRING);
        Sg.put(66, SKIING_BACK_COUNTRY_STRING);
        Sg.put(67, SKIING_CROSS_COUNTRY_STRING);
        Sg.put(68, SKIING_DOWNHILL_STRING);
        Sg.put(69, SKIING_KITE_STRING);
        Sg.put(70, SKIING_ROLLER_STRING);
        Sg.put(71, SLEDDING_STRING);
        Sg.put(72, SLEEP_STRING);
        Sg.put(73, SNOWBOARDING_STRING);
        Sg.put(74, SNOWMOBILE_STRING);
        Sg.put(75, SNOWSHOEING_STRING);
        Sg.put(76, SQUASH_STRING);
        Sg.put(77, STAIR_CLIMBING_STRING);
        Sg.put(78, STAIR_CLIMBING_MACHINE_STRING);
        Sg.put(79, STANDUP_PADDLEBOARDING_STRING);
        Sg.put(3, STILL_STRING);
        Sg.put(80, STRENGTH_TRAINING_STRING);
        Sg.put(81, SURFING_STRING);
        Sg.put(82, SWIMMING_STRING);
        Sg.put(83, SWIMMING_POOL_STRING);
        Sg.put(84, SWIMMING_OPEN_WATER_STRING);
        Sg.put(85, TABLE_TENNIS_STRING);
        Sg.put(86, TEAM_SPORTS_STRING);
        Sg.put(87, TENNIS_STRING);
        Sg.put(5, TILTING_STRING);
        Sg.put(88, TREADMILL_STRING);
        Sg.put(4, "unknown");
        Sg.put(89, VOLLEYBALL_STRING);
        Sg.put(90, VOLLEYBALL_BEACH_STRING);
        Sg.put(91, VOLLEYBALL_INDOOR_STRING);
        Sg.put(92, WAKEBOARDING_STRING);
        Sg.put(7, WALKING_STRING);
        Sg.put(93, WALKING_FITNESS_STRING);
        Sg.put(94, WALKING_NORDIC_STRING);
        Sg.put(95, WALKING_TREADMILL_STRING);
        Sg.put(96, WATER_POLO_STRING);
        Sg.put(97, WEIGHTLIFTING_STRING);
        Sg.put(98, WHEELCHAIR_STRING);
        Sg.put(99, WINDSURFING_STRING);
        Sg.put(100, YOGA_STRING);
        Sg.put(101, ZUMBA_STRING);
    }
