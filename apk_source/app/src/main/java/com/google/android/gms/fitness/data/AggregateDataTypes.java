...
public class AggregateDataTypes {
    ...
    public static final Set<DataType> INPUT_TYPES = new HashSet(Arrays.asList(DataTypes.STEP_COUNT_DELTA, DataTypes.DISTANCE_DELTA, DataTypes.ACTIVITY_SEGMENT, DataTypes.SPEED, DataTypes.HEART_RATE_BPM, DataTypes.WEIGHT, DataTypes.LOCATION_SAMPLE));
    ...
    private static final Map<DataType, List<DataType>> So = new HashMap<DataType, List<DataType>>() { // from class: com.google.android.gms.fitness.data.AggregateDataTypes.1
        {
