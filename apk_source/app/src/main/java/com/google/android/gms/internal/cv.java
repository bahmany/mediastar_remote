...
public interface cv extends IInterface {
    ...
    public static abstract class a extends Binder implements cv {
        ...
        private static class C0044a implements cv {
            private IBinder lb;
        ...
        public static cv n(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof cv)) ? new C0044a(iBinder) : (cv) iInterfaceQueryLocalInterface;
        }
