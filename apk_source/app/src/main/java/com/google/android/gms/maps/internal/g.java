...
public interface g extends IInterface {
    ...
    public static abstract class a extends Binder implements g {
        ...
        private static class C0113a implements g {
            private IBinder lb;
        ...
        public static g aX(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof g)) ? new C0113a(iBinder) : (g) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    e(f.a.bu(data.readStrongBinder()));
