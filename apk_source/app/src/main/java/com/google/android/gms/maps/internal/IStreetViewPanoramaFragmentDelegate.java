...
public interface IStreetViewPanoramaFragmentDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements IStreetViewPanoramaFragmentDelegate {
        ...
        private static class C0105a implements IStreetViewPanoramaFragmentDelegate {
            private IBinder lb;
            ...
            public IStreetViewPanoramaDelegate getStreetViewPanorama() throws RemoteException {
                ...
                try {
                    ...
                    return IStreetViewPanoramaDelegate.a.bl(parcelObtain2.readStrongBinder());
                } finally {
        ...
        public static IStreetViewPanoramaFragmentDelegate bm(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IStreetViewPanoramaFragmentDelegate)) ? new C0105a(iBinder) : (IStreetViewPanoramaFragmentDelegate) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                    onInflate(d.a.am(data.readStrongBinder()), data.readInt() != 0 ? StreetViewPanoramaOptions.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                ...
                case 4:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                    com.google.android.gms.dynamic.d dVarOnCreateView = onCreateView(d.a.am(data.readStrongBinder()), d.a.am(data.readStrongBinder()), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
