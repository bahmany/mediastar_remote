...
public interface m extends IInterface {
    ...
    public static abstract class a extends Binder implements m {
        ...
        private static class C0119a implements m {
            private IBinder lb;
        ...
        public static m bd(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof m)) ? new C0119a(iBinder) : (m) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    b(f.a.bu(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IOnMarkerDragListener");
                    d(f.a.bu(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface("com.google.android.gms.maps.internal.IOnMarkerDragListener");
                    c(f.a.bu(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
