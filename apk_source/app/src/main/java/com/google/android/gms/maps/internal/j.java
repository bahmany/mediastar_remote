...
public interface j extends IInterface {
    ...
    public static abstract class a extends Binder implements j {
        ...
        private static class C0116a implements j {
            private IBinder lb;
        ...
        public static j ba(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof j)) ? new C0116a(iBinder) : (j) iInterfaceQueryLocalInterface;
        }
