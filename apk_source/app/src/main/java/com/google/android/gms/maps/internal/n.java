...
public interface n extends IInterface {
    ...
    public static abstract class a extends Binder implements n {
        ...
        private static class C0120a implements n {
            private IBinder lb;
        ...
        public static n be(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof n)) ? new C0120a(iBinder) : (n) iInterfaceQueryLocalInterface;
        }
