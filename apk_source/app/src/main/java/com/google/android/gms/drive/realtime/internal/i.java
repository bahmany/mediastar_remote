...
public interface i extends IInterface {
    ...
    public static abstract class a extends Binder implements i {
        ...
        private static class C0022a implements i {
            private IBinder lb;
        ...
        public static i ae(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof i)) ? new C0022a(iBinder) : (i) iInterfaceQueryLocalInterface;
        }
