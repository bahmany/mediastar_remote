...
public interface ou extends IInterface {
    ...
    public static abstract class a extends Binder implements ou {
        ...
        /* renamed from: com.google.android.gms.internal.ou$a$a, reason: collision with other inner class name */
        private static class C0090a implements ou {
            private IBinder lb;
        ...
        public static ou bN(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ou)) ? new C0090a(iBinder) : (ou) iInterfaceQueryLocalInterface;
        }
