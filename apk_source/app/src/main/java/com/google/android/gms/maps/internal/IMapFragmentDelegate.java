...
public interface IMapFragmentDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements IMapFragmentDelegate {
        ...
        private static class C0101a implements IMapFragmentDelegate {
            private IBinder lb;
            ...
            public IGoogleMapDelegate getMap() throws RemoteException {
                ...
                try {
                    ...
                    return IGoogleMapDelegate.a.aQ(parcelObtain2.readStrongBinder());
                } finally {
        ...
        public static IMapFragmentDelegate aT(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IMapFragmentDelegate)) ? new C0101a(iBinder) : (IMapFragmentDelegate) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                    onInflate(d.a.am(data.readStrongBinder()), data.readInt() != 0 ? GoogleMapOptions.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
