...
final class PDF417HighLevelEncoder {
    ...
    private static final byte[] TEXT_PUNCTUATION_RAW = {59, 60, 62, 64, SocksProxyConstants.V4_REPLY_REQUEST_REJECTED_OR_FAILED, SocksProxyConstants.V4_REPLY_REQUEST_FAILED_NO_IDENTD, SocksProxyConstants.V4_REPLY_REQUEST_FAILED_ID_NOT_CONFIRMED, 95, 96, 126, 33, 13, 9, 44, 58, 10, 45, 46, 36, 47, 34, 124, 42, 40, 41, 63, 123, 125, 39, 0};
