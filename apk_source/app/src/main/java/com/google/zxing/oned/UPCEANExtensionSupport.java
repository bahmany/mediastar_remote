...
final class UPCEANExtensionSupport {
    ...
    private static Map<ResultMetadataType, Object> parseExtensionString(String raw) throws NumberFormatException {
        ResultMetadataType type;
        Object extension5String;
        switch (raw.length()) {
            case 2:
                type = ResultMetadataType.ISSUE_NUMBER;
                extension5String = parseExtension2String(raw);
                break;
            case 3:
            case 4:
            default:
            ...
            case 5:
                ...
                extension5String = parseExtension5String(raw);
                break;
        }
        ...
        result.put(type, extension5String);
        return result;
    }
    ...
    private static String parseExtension5String(String raw) throws NumberFormatException {
        String currency;
        switch (raw.charAt(0)) {
            case '0':
                currency = "£";
