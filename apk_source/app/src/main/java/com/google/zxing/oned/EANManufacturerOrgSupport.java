...
final class EANManufacturerOrgSupport {
    ...
    String lookupCountryIdentifier(String productCode) throws NumberFormatException {
        initIfNeeded();
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{60, KeyInfo.KEYCODE_MENU}, "US/CA");
            ...
            add(new int[]{477}, "LT");
            add(new int[]{478}, "UZ");
            add(new int[]{KeyInfo.KEYCODE_MORE}, "LK");
            add(new int[]{480}, "PH");
            add(new int[]{481}, "BY");
            add(new int[]{482}, "UA");
            add(new int[]{484}, "MD");
            ...
            add(new int[]{759}, "VE");
            add(new int[]{760, PushMessageHead.DEFAULT_RESPONSE}, "CH");
            add(new int[]{PushMessageHead.GET_APPS_REQUEST}, "CO");
            add(new int[]{PushMessageHead.PLAY_MEDIA}, "UY");
            add(new int[]{775}, "PE");
            add(new int[]{777}, "BO");
            add(new int[]{779}, "AR");
            add(new int[]{780}, "CL");
