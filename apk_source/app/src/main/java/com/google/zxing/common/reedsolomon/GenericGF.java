...
public final class GenericGF {
    ...
    public static final GenericGF AZTEC_DATA_10 = new GenericGF(GlobalConstantValue.GMS_MSG_DO_FACTORY_DEFAULT_SCRAMBLE, 1024);
    ...
    public static final GenericGF DATA_MATRIX_FIELD_256 = new GenericGF(GlobalConstantValue.GMS_MSG_SPE_REQUEST_SPECTRUM_INFO, 256);
