...
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    private static final int[] EVEN_TOTAL_SUBSET = {4, 20, 52, 104, HTTPStatus.NO_CONTENT};
    private static final int[] GSUM = {0, 348, 1388, 2948, 3988};
    private static final int[][] FINDER_PATTERNS = {new int[]{1, 8, 4, 1}, new int[]{3, 6, 4, 1}, new int[]{3, 4, 6, 1}, new int[]{3, 2, 8, 1}, new int[]{2, 6, 5, 1}, new int[]{2, 2, 9, 1}};
    private static final int[][] WEIGHTS = {new int[]{1, 3, 9, 27, 81, 32, 96, 77}, new int[]{20, 60, Opcodes.GETFIELD, 118, 143, 7, 21, 63}, new int[]{189, Opcodes.I2B, 13, 39, 117, 140, 209, HTTPStatus.RESET_CONTENT}, new int[]{Opcodes.INSTANCEOF, Opcodes.IFGT, 49, Opcodes.I2S, 19, 57, 171, 91}, new int[]{62, 186, 136, 197, Opcodes.RET, 85, 44, Opcodes.IINC}, new int[]{Opcodes.INVOKEINTERFACE, 133, 188, 142, 4, 12, 36, 108}, new int[]{KeyInfo.KEYCODE_MUTE, 128, 173, 97, 80, 29, 87, 50}, new int[]{Opcodes.FCMPG, 28, 84, 41, 123, 158, 52, Opcodes.IFGE}, new int[]{46, 138, HTTPStatus.NON_AUTHORITATIVE_INFORMATION, Opcodes.NEW, KeyInfo.KEYCODE_MENU, 206, 196, Opcodes.IF_ACMPNE}, new int[]{76, 17, 51, Opcodes.IFEQ, 37, 111, 122, Opcodes.IFLT}, new int[]{43, 129, Opcodes.ARETURN, 106, FitnessActivities.KICK_SCOOTER, 110, 119, Opcodes.I2C}, new int[]{16, 48, 144, 10, 30, 90, 59, Opcodes.RETURN}, new int[]{KeyInfo.KEYCODE_NEXT, 116, 137, 200, Opcodes.GETSTATIC, 112, 125, 164}, new int[]{70, 210, 208, HTTPStatus.ACCEPTED, Opcodes.INVOKESTATIC, TransportMediator.KEYCODE_MEDIA_RECORD, Opcodes.PUTSTATIC, KeyInfo.KEYCODE_VOLUME_UP}, new int[]{134, 191, Opcodes.DCMPL, 31, 93, 68, HTTPStatus.NO_CONTENT, 190}, new int[]{Opcodes.LCMP, 22, 66, Opcodes.IFNULL, Opcodes.IRETURN, 94, 71, 2}, new int[]{6, 18, 54, Opcodes.IF_ICMPGE, 64, Opcodes.CHECKCAST, Opcodes.IFNE, 40}, new int[]{KeyInfo.KEYCODE_ASK, Opcodes.FCMPL, 25, 75, 14, 42, 126, Opcodes.GOTO}, new int[]{79, 26, 78, 23, 69, 207, Opcodes.IFNONNULL, 175}, new int[]{103, 98, 83, 38, KeyInfo.KEYCODE_VOLUME_DOWN, 131, Opcodes.INVOKEVIRTUAL, 124}, new int[]{Opcodes.IF_ICMPLT, 61, Opcodes.INVOKESPECIAL, TransportMediator.KEYCODE_MEDIA_PAUSE, 170, 88, 53, 159}, new int[]{55, Opcodes.IF_ACMPEQ, 73, 8, 24, 72, 5, 15}, new int[]{45, 135, 194, Opcodes.IF_ICMPNE, 58, 174, 100, 89}};
