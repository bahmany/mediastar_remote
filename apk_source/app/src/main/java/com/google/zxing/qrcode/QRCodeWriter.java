...
public final class QRCodeWriter implements Writer {
    ...
    @Override // com.google.zxing.Writer
    public BitMatrix encode(String contents, BarcodeFormat format, int width, int height, Map<EncodeHintType, ?> hints) throws WriterException, UnsupportedEncodingException {
