...
public final class Decoder {
    ...
    private static final int[] NB_BITS_COMPACT = {0, 104, 240, HTTPStatus.REQUEST_TIMEOUT, 608};
    private static final int[] NB_BITS = {0, 128, 288, 480, 704, 960, 1248, 1568, 1920, 2304, 2720, 3168, 3648, 4160, 4704, 5280, 5888, 6528, 7200, 7904, 8640, 9408, ErrorCode.MSP_ERROR_NET_BINDSEQUENCE, 11040, 11904, 12800, 13728, 14688, 15680, 16704, 17760, 18848, 19968};
    private static final int[] NB_DATABLOCK_COMPACT = {0, 17, 40, 51, 76};
    private static final int[] NB_DATABLOCK = {0, 21, 48, 60, 88, KeyInfo.KEYCODE_ASK, Opcodes.IFGE, 196, 240, KeyInfo.KEYCODE_A, 272, 316, 364, 416, 470, 528, 588, 652, 720, 790, 864, 940, GlobalConstantValue.GMS_MSG_DO_EVENT_TIMER_DELETE, 920, 992, 1066, 1144, 1224, 1306, 1392, 1480, 1570, 1664};
    ...
    private static final String[] LOWER_TABLE = {"CTRL_PS", " ", "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", MessageElement.XPATH_PREFIX, "n", "o", "p", "q", "r", SOAP.XMLNS, "t", "u", "v", "w", "x", "y", "z", "CTRL_US", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    private static final String[] MIXED_TABLE = {"CTRL_PS", " ", "\u0001", "\u0002", "\u0003", "\u0004", "\u0005", "\u0006", "\u0007", "\b", "\t", "\n", "\u000b", "\f", "\r", "\u001b", "\u001c", "\u001d", "\u001e", "\u001f", "@", "\\", "^", "_", "`", "|", "~", "\u007f", "CTRL_LL", "CTRL_UL", "CTRL_PL", "CTRL_BS"};
    private static final String[] PUNCT_TABLE = {"", "\r", "\r\n", ". ", ", ", ": ", "!", "\"", "#", "$", "%", "&", "'", "(", ")", "*", Marker.ANY_NON_NULL_MARKER, ClientInfo.SEPARATOR_BETWEEN_VARS, "-", ".", ServiceReference.DELIMITER, ":", VoiceWakeuperAidl.PARAMS_SEPARATE, "<", "=", ">", "?", "[", "]", "{", "}", "CTRL_UL"};
    private static final String[] DIGIT_TABLE = {"CTRL_PS", " ", "0", "1", ContentTree.AUDIO_ID, ContentTree.IMAGE_ID, ContentTree.ALL_VIDEO_ID, ContentTree.ALL_AUDIO_ID, ContentTree.ALL_IMAGE_ID, ContentTree.VIDEO_FOLDER_ID, ContentTree.AUDIO_FOLDER_ID, ContentTree.IMAGE_FOLDER_ID, ClientInfo.SEPARATOR_BETWEEN_VARS, ".", "CTRL_UL", "CTRL_US"};
