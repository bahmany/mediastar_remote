...
public final class Deflate implements Cloneable {
    ...
    boolean _tr_tally(int dist, int lc) {
        ...
        if (dist == 0) {
            ...
            int iD_code = Tree.d_code(dist - 1) * 2;
    ...
    void _tr_flush_block(int buf, int stored_len, boolean eof) {
        ...
        if (stored_len + 4 <= opt_lenb && buf != -1) {
            ...
            send_bits((eof ? 1 : 0) + 2, 3);
            compress_block(StaticTree.static_ltree, StaticTree.static_dtree);
        } else {
            send_bits((eof ? 1 : 0) + 4, 3);
    ...
    int deflate_slow(int flush) {
        ...
        while (true) {
            ...
            if (this.prev_length >= 3 && this.match_length <= this.prev_length) {
                ...
                boolean bflush2 = _tr_tally(0, this.window[this.strstart - 1] & 255);
                if (bflush2) {
                    flush_block_only(false);
                }
                this.strstart++;
    ...
    /* JADX WARN: Removed duplicated region for block: B:118:0x0076 A[EDGE_INSN: B:118:0x0076->B:90:0x0076 BREAK  A[LOOP:0: B:78:0x003a->B:122:?], SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:86:0x0065 A[PHI: r0 r6 r7 r8
  0x0065: PHI (r0v2 'best_len' int) = 
  (r0v1 'best_len' int)
  (r0v1 'best_len' int)
  (r0v1 'best_len' int)
  (r0v1 'best_len' int)
  (r0v1 'best_len' int)
  (r0v5 'best_len' int)
 binds: [B:79:0x0041, B:81:0x004b, B:83:0x0055, B:85:0x0063, B:113:0x00f9, B:116:0x0100] A[DONT_GENERATE, DONT_INLINE]
  0x0065: PHI (r6v2 'scan' int) = (r6v1 'scan' int), (r6v1 'scan' int), (r6v1 'scan' int), (r6v1 'scan' int), (r6v7 'scan' int), (r6v7 'scan' int) binds: [B:79:0x0041, B:81:0x004b, B:83:0x0055, B:85:0x0063, B:113:0x00f9, B:116:0x0100] A[DONT_GENERATE, DONT_INLINE]
  0x0065: PHI (r7v2 'scan_end' byte) = 
  (r7v1 'scan_end' byte)
  (r7v1 'scan_end' byte)
  (r7v1 'scan_end' byte)
  (r7v1 'scan_end' byte)
  ...
  (r7v3 'scan_end' byte)
 binds: [B:79:0x0041, B:81:0x004b, B:83:0x0055, B:85:0x0063, B:113:0x00f9, B:116:0x0100] A[DONT_GENERATE, DONT_INLINE]
  0x0065: PHI (r8v2 'scan_end1' byte) = 
  (r8v1 'scan_end1' byte)
  (r8v1 'scan_end1' byte)
  (r8v1 'scan_end1' byte)
  (r8v1 'scan_end1' byte)
 ...
 binds: [B:79:0x0041, B:81:0x004b, B:83:0x0055, B:85:0x0063, B:113:0x00f9, B:116:0x0100] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    int deflate(int flush) {
        ...
        if (this.wrap == 2) {
            long adler2 = this.strm.adler.getValue();
            put_byte((byte) (255 & adler2));
            put_byte((byte) ((adler2 >> 8) & 255));
            put_byte((byte) ((adler2 >> 16) & 255));
            put_byte((byte) ((adler2 >> 24) & 255));
            ...
            getGZIPHeader().setCRC(adler2);
        } else {
            long adler3 = this.strm.adler.getValue();
            putShortMSB((int) (adler3 >>> 16));
            putShortMSB((int) (65535 & adler3));
        }
        this.strm.flush_pending();
        if (this.wrap > 0) {
            this.wrap = -this.wrap;
