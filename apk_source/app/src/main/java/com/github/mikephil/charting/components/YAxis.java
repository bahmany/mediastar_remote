...
public class YAxis extends AxisBase {
    ...
    public enum AxisDependency {
        ...
        public static AxisDependency[] valuesCustom() {
            AxisDependency[] axisDependencyArrValuesCustom = values();
            int length = axisDependencyArrValuesCustom.length;
            AxisDependency[] axisDependencyArr = new AxisDependency[length];
            System.arraycopy(axisDependencyArrValuesCustom, 0, axisDependencyArr, 0, length);
    ...
    public enum YAxisLabelPosition {
        ...
        public static YAxisLabelPosition[] valuesCustom() {
            YAxisLabelPosition[] yAxisLabelPositionArrValuesCustom = values();
            int length = yAxisLabelPositionArrValuesCustom.length;
            YAxisLabelPosition[] yAxisLabelPositionArr = new YAxisLabelPosition[length];
            System.arraycopy(yAxisLabelPositionArrValuesCustom, 0, yAxisLabelPositionArr, 0, length);
    ...
    public float getRequiredHeightSpace(Paint p) {
        p.setTextSize(this.mTextSize);
        String label = getLongestLabel();
        return Utils.calcTextHeight(p, label) + (Utils.convertDpToPixel(2.5f) * 2.0f) + getYOffset();
    }
    ...
    public String getFormattedLabel(int index) {
        return (index < 0 || index >= this.mEntries.length) ? "" : getValueFormatter().getFormattedValue(this.mEntries[index], this);
    }
