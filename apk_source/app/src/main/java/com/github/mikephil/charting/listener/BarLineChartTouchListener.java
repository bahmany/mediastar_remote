        ...
        if (((BarLineChartBase) this.mChart).isDragEnabled() || ((BarLineChartBase) this.mChart).isScaleXEnabled() || ((BarLineChartBase) this.mChart).isScaleYEnabled()) {
            switch (event.getAction() & 255) {
                ...
                case 2:
                    ...
                    } else if (this.mTouchMode == 0 && Math.abs(distance(event.getX(), this.mTouchStartPoint.x, event.getY(), this.mTouchStartPoint.y)) > 5.0f) {
        ...
        if (event.getPointerCount() >= 2) {
            ...
            if (totalDist > 10.0f) {
                ...
                if (this.mTouchMode == 4) {
                    ...
                    if (isZoomingOut) {
                        canZoomMoreX2 = ((BarLineChartBase) this.mChart).getViewPortHandler().canZoomOutMoreX();
                    } else {
                        canZoomMoreX2 = ((BarLineChartBase) this.mChart).getViewPortHandler().canZoomInMoreX();
                    }
                    ...
                    if (((BarLineChartBase) this.mChart).isScaleYEnabled() || canZoomMoreX2) {
                        this.mMatrix.set(this.mSavedMatrix);
