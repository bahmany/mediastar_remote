...
public class Legend extends ComponentBase {
    ...
    public enum LegendDirection {
        ...
        public static LegendDirection[] valuesCustom() {
            LegendDirection[] legendDirectionArrValuesCustom = values();
            int length = legendDirectionArrValuesCustom.length;
            LegendDirection[] legendDirectionArr = new LegendDirection[length];
            System.arraycopy(legendDirectionArrValuesCustom, 0, legendDirectionArr, 0, length);
    ...
    public enum LegendForm {
        ...
        public static LegendForm[] valuesCustom() {
            LegendForm[] legendFormArrValuesCustom = values();
            int length = legendFormArrValuesCustom.length;
            LegendForm[] legendFormArr = new LegendForm[length];
            System.arraycopy(legendFormArrValuesCustom, 0, legendFormArr, 0, length);
    ...
    public enum LegendPosition {
        ...
        public static LegendPosition[] valuesCustom() {
            LegendPosition[] legendPositionArrValuesCustom = values();
            int length = legendPositionArrValuesCustom.length;
            LegendPosition[] legendPositionArr = new LegendPosition[length];
            System.arraycopy(legendPositionArrValuesCustom, 0, legendPositionArr, 0, length);
    ...
    public void calculateDimensions(Paint labelpaint, ViewPortHandler viewPortHandler) {
        ...
        if (this.mPosition == LegendPosition.BELOW_CHART_LEFT || this.mPosition == LegendPosition.BELOW_CHART_RIGHT || this.mPosition == LegendPosition.BELOW_CHART_CENTER || this.mPosition == LegendPosition.ABOVE_CHART_LEFT || this.mPosition == LegendPosition.ABOVE_CHART_RIGHT || this.mPosition == LegendPosition.ABOVE_CHART_CENTER) {
            ...
            for (int i = 0; i < labelCount; i++) {
                ...
                if (this.mLabels[i] != null) {
                    ...
                    requiredWidth2 = requiredWidth + (drawingForm ? this.mFormToTextSpace + this.mFormSize : 0.0f) + calculatedLabelSizes.get(i).width;
                } else {
            ...
            this.mNeededHeight = ((this.mCalculatedLineSizes.length == 0 ? 0 : this.mCalculatedLineSizes.length - 1) * labelLineSpacing) + (labelLineHeight * this.mCalculatedLineSizes.length);
            return;
        }
