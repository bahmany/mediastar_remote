...
public class Argument {
    ...
    private void astring(byte[] bytes, Protocol protocol) throws ProtocolException, IOException {
        DataOutputStream os = (DataOutputStream) protocol.getOutputStream();
    ...
    private void literal(byte[] b, Protocol protocol) throws ProtocolException, IOException {
        startLiteral(protocol, b.length).write(b);
    }

    private void literal(ByteArrayOutputStream b, Protocol protocol) throws ProtocolException, IOException {
        b.writeTo(startLiteral(protocol, b.size()));
    }

    private void literal(Literal b, Protocol protocol) throws ProtocolException, IOException {
        b.writeTo(startLiteral(protocol, b.size()));
    }

    private OutputStream startLiteral(Protocol protocol, int size) throws ProtocolException, IOException {
        Response r;
        DataOutputStream os = (DataOutputStream) protocol.getOutputStream();
