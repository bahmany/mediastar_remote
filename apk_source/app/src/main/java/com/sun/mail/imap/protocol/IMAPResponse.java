...
public class IMAPResponse extends Response {
    ...
    public IMAPResponse(Protocol c) throws ProtocolException, IOException {
        super(c);
    ...
    public static IMAPResponse readResponse(Protocol p) throws ProtocolException, IOException {
