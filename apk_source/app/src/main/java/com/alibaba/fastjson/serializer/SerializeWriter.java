...
public final class SerializeWriter extends Writer {
    ...
    public void writeEnum(Enum<?> value, char c) throws IOException {
        if (value == null) {
            writeNull();
            write(',');
            return;
    ...
    */
    ...
    public void writeFieldValue(char seperator, String name, int value) throws IOException {
    ...
    public void writeFieldValue1(char seperator, String name, int value) throws IOException {
        write(seperator);
        writeFieldName(name);
        writeInt(value);
    }

    public void writeFieldValue(char seperator, String name, long value) throws IOException {
    ...
    public void writeFieldValue1(char seperator, String name, long value) throws IOException {
        write(seperator);
        writeFieldName(name);
        writeLong(value);
    }
    ...
    public void writeFieldValue(char seperator, String name, Enum<?> value) throws IOException {
        if (value == null) {
            write(seperator);
            writeFieldName(name);
            writeNull();
