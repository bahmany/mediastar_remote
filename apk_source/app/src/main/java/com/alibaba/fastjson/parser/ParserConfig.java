...
public class ParserConfig {
    ...
    public ObjectDeserializer createJavaBeanDeserializer(Class<?> clazz, Type type) throws SecurityException {
        ...
        if (asmEnable) {
            ...
            Iterator<FieldInfo> it = beanInfo.getFieldList().iterator();
            while (true) {
                if (!it.hasNext()) {
                    break;
                }
