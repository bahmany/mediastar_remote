...
public class FieldInfo implements Comparable<FieldInfo> {
    ...
    public FieldInfo(String name, Method method, Field field, Class<?> clazz, Type type, int ordinal, int serialzeFeatures) {
        ...
        if (clazz != null && fieldClass == Object.class && (fieldType instanceof TypeVariable)) {
            TypeVariable<?> tv2 = (TypeVariable) fieldType;
            Type genericFieldType = getInheritGenericType(clazz, tv2);
    ...
    public static Type getInheritGenericType(Class<?> clazz, TypeVariable<?> tv2) {
        Type type;
        GenericDeclaration gd = tv2.getGenericDeclaration();
        do {
