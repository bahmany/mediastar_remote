...
public final class JSONScanner extends JSONLexerBase {
    ...
    public boolean scanISO8601DateIfMatch(boolean strict) throws NumberFormatException {
        int hour;
        int minute;
        int seconds;
        int millis;
        ...
        if (rest < this.ISO8601_LEN_0 || charAt(this.bp + 4) != '-' || charAt(this.bp + 7) != '-') {
            return false;
        }
        ...
        if (t == 'T' || (t == ' ' && !strict)) {
            ...
            if (dot == '.') {
                ...
                int i2 = this.bp + millisLen + 20 + timzeZoneLength;
                this.bp = i2;
                this.ch = charAt(i2);
                this.token = 5;
                return true;
    ...
    public String scanFieldSymbol(char[] fieldName, SymbolTable symbolTable) {
        ...
        do {
            ...
            if (ch == '\"') {
                ...
                this.ch = ch2;
                String strAddSymbol = symbolTable.addSymbol(this.text, index2, (index2 - index2) - 1, hash);
                if (ch2 == ',') {
                    int i = this.bp + 1;
                    this.bp = i;
                    this.ch = charAt(i);
