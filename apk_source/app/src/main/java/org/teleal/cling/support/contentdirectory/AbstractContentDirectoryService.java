...
@UpnpStateVariables({@UpnpStateVariable(datatype = "string", name = "A_ARG_TYPE_ObjectID", sendEvents = BuildConfig.DEBUG), @UpnpStateVariable(datatype = "string", name = "A_ARG_TYPE_Result", sendEvents = BuildConfig.DEBUG), @UpnpStateVariable(allowedValuesEnum = BrowseFlag.class, datatype = "string", name = "A_ARG_TYPE_BrowseFlag", sendEvents = BuildConfig.DEBUG), @UpnpStateVariable(datatype = "string", name = "A_ARG_TYPE_Filter", sendEvents = BuildConfig.DEBUG), @UpnpStateVariable(datatype = "string", name = "A_ARG_TYPE_SortCriteria", sendEvents = BuildConfig.DEBUG), @UpnpStateVariable(datatype = "ui4", name = "A_ARG_TYPE_Index", sendEvents = BuildConfig.DEBUG), @UpnpStateVariable(datatype = "ui4", name = "A_ARG_TYPE_Count", sendEvents = BuildConfig.DEBUG), @UpnpStateVariable(datatype = "ui4", name = "A_ARG_TYPE_UpdateID", sendEvents = BuildConfig.DEBUG), @UpnpStateVariable(datatype = "uri", name = "A_ARG_TYPE_URI", sendEvents = BuildConfig.DEBUG), @UpnpStateVariable(datatype = "string", name = "A_ARG_TYPE_SearchCriteria", sendEvents = BuildConfig.DEBUG)})
/* loaded from: classes.dex */
public abstract class AbstractContentDirectoryService {
    public static final String CAPS_WILDCARD = "*";
    protected final PropertyChangeSupport propertyChangeSupport;

    @UpnpStateVariable(sendEvents = BuildConfig.DEBUG)
    private final CSV<String> searchCapabilities;

    @UpnpStateVariable(sendEvents = BuildConfig.DEBUG)
    private final CSV<String> sortCapabilities;

    @UpnpStateVariable(defaultValue = "0", eventMaximumRateMilliseconds = 200, sendEvents = com.hisilicon.multiscreen.http.BuildConfig.DEBUG)
