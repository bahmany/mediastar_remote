...
public class SoapActionType {
    ...
    public String toString() {
        return String.valueOf(getTypeString()) + "#" + getActionName();
    }

    public String getTypeString() {
        return this.version == null ? "urn:" + getNamespace() + ":" + getType() : "urn:" + getNamespace() + ":service:" + getType() + ":" + getVersion();
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + this.type.hashCode()) * 31) + this.actionName.hashCode()) * 31) + (this.version != null ? this.version.hashCode() : 0);
    }
}
