...
public enum AVTransportErrorCode {
    ...
    public static AVTransportErrorCode[] valuesCustom() {
        AVTransportErrorCode[] aVTransportErrorCodeArrValuesCustom = values();
        int length = aVTransportErrorCodeArrValuesCustom.length;
        AVTransportErrorCode[] aVTransportErrorCodeArr = new AVTransportErrorCode[length];
        System.arraycopy(aVTransportErrorCodeArrValuesCustom, 0, aVTransportErrorCodeArr, 0, length);
    ...
    public static AVTransportErrorCode getByCode(int code) {
        for (AVTransportErrorCode errorCode : valuesCustom()) {
