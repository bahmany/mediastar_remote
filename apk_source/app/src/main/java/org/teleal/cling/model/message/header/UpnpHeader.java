...
public abstract class UpnpHeader<T> {
    ...
    public enum Type {
        ...
        SERVER(HTTP.SERVER, ServerHeader.class),
        LOCATION(HTTP.LOCATION, LocationHeader.class),
        MAX_AGE(HTTP.CACHE_CONTROL, MaxAgeHeader.class),
        USER_AGENT("USER-AGENT", UserAgentHeader.class),
        CONTENT_TYPE(HTTP.CONTENT_TYPE, ContentTypeHeader.class),
        ...
        /* renamed from: org.teleal.cling.model.message.header.UpnpHeader$Type$1 */
        class AnonymousClass1 extends HashMap<String, Type> {
            AnonymousClass1() {
                for (Type t : Type.valuesCustom()) {
                    put(t.getHttpName(), t);
                }
        ...
        Type(String httpName, Class... headerClass) {
    ...
    public static UpnpHeader newInstance(Type type, String headerValue) throws IllegalAccessException, InstantiationException {
