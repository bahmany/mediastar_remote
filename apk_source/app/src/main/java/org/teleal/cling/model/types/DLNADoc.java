...
public class DLNADoc {
    ...
    public enum Version {
        ...
        public static Version[] valuesCustom() {
            Version[] versionArrValuesCustom = values();
            int length = versionArrValuesCustom.length;
            Version[] versionArr = new Version[length];
            System.arraycopy(versionArrValuesCustom, 0, versionArr, 0, length);
            return versionArr;
        }
    ...
    public String toString() {
        return String.valueOf(getDevClass()) + "-" + getVersion();
    }
}
