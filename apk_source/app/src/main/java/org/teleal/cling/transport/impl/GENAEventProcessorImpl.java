...
public class GENAEventProcessorImpl implements GENAEventProcessor {
    ...
    @Override // org.teleal.cling.transport.spi.GENAEventProcessor
    public void readBody(IncomingEventRequestMessage requestMessage) throws SAXException, UnsupportedDataException, IOException {
    ...
    protected Element writePropertysetElement(Document d) throws DOMException {
    ...
    protected void writeProperties(Document d, Element propertysetElement, OutgoingEventRequestMessage message) throws DOMException {
