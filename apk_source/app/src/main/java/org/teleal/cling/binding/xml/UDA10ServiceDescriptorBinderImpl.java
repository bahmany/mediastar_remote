...
public class UDA10ServiceDescriptorBinderImpl implements ServiceDescriptorBinder {
    ...
    public <S extends Service> S describe(S s, String str) throws ValidationException, DescriptorBindingException {
        ...
        try {
            ...
            return (S) describe((UDA10ServiceDescriptorBinderImpl) s, documentBuilderFactoryNewInstance.newDocumentBuilder().parse(new InputSource(new StringReader(str.trim()))));
    ...
    public void hydrateStateVariable(MutableStateVariable stateVariable, Element stateVariableElement) {
        stateVariable.eventDetails = new StateVariableEventDetails(stateVariableElement.getAttribute("sendEvents") != null && stateVariableElement.getAttribute(Descriptor.Service.ATTRIBUTE.sendEvents.toString()).toUpperCase().equals("YES"));
    ...
    private void generateScpd(Service serviceModel, Document descriptor) throws DOMException {
    ...
    private void generateActionArgument(ActionArgument actionArgument, Document descriptor, Element actionElement) {
        ...
        XMLUtil.appendNewElementIfNotNull(descriptor, actionArgumentElement, Descriptor.Service.ELEMENT.direction, actionArgument.getDirection().toString().toLowerCase());
        ...
        if (actionArgument.isReturnValue()) {
            XMLUtil.appendNewElement(descriptor, actionArgumentElement, Descriptor.Service.ELEMENT.retval);
        }
    }

    private void generateServiceStateTable(Service serviceModel, Document descriptor, Element scpdElement) throws DOMException {
    ...
    private void generateStateVariable(StateVariable stateVariable, Document descriptor, Element serviveStateTableElement) throws DOMException {
