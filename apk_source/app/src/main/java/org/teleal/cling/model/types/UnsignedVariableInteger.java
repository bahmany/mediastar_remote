...
public abstract class UnsignedVariableInteger {
    ...
    public enum Bits {
        ...
        public static Bits[] valuesCustom() {
            Bits[] bitsArrValuesCustom = values();
            int length = bitsArrValuesCustom.length;
            Bits[] bitsArr = new Bits[length];
            System.arraycopy(bitsArrValuesCustom, 0, bitsArr, 0, length);
            return bitsArr;
        }
    ...
    protected UnsignedVariableInteger setValue(long value) throws NumberFormatException {
        isInRange(value);
        this.value = value;
        return this;
    }
