...
public class DIDLParser extends SAXParser {
    ...
    protected DescMeta createDescMeta(Attributes attributes) {
        ...
        if (attributes.getValue(PlaylistSQLiteHelper.COL_TYPE) != null) {
            desc.setType(attributes.getValue(PlaylistSQLiteHelper.COL_TYPE));
        }
    ...
    protected void generateRoot(DIDLContent content, Document descriptor, boolean nestedItems) throws DOMException {
    ...
    protected void generateContainer(Container container, Document descriptor, Element parent, boolean nestedItems) throws DOMException {
        ...
        XMLUtil.appendNewElementIfNotNull(descriptor, containerElement, "dc:title", container.getTitle(), DIDLObject.Property.DC.NAMESPACE.URI);
    ...
    protected void generateItem(Item item, Document descriptor, Element parent) throws DOMException {
        ...
        XMLUtil.appendNewElementIfNotNull(descriptor, itemElement, "dc:title", item.getTitle(), DIDLObject.Property.DC.NAMESPACE.URI);
    ...
    protected void generateResource(Res resource, Document descriptor, Element parent) throws DOMException {
    ...
    protected void generateDescMetadata(DescMeta descMeta, Document descriptor, Element parent) throws DOMException {
        ...
        if (descMeta.getType() != null) {
            descElement.setAttribute(PlaylistSQLiteHelper.COL_TYPE, descMeta.getType());
        }
        populateDescMetadata(descElement, descMeta);
    }

    protected void populateDescMetadata(Element descElement, DescMeta descMeta) throws DOMException {
    ...
    protected void appendProperties(Document descriptor, Element parent, DIDLObject object, String prefix, Class<? extends DIDLObject.Property.NAMESPACE> namespace, String namespaceURI) throws DOMException {
        for (DIDLObject.Property<Object> property : object.getPropertiesByNamespace(namespace)) {
            Element el = descriptor.createElementNS(namespaceURI, String.valueOf(prefix) + ":" + property.getDescriptorName());
            parent.appendChild(el);
            property.setOnElement(el);
        }
    }

    protected void appendClass(Document descriptor, Element parent, DIDLObject.Class clazz, String element, boolean appendDerivation) throws DOMException {
    ...
    public abstract class DIDLObjectHandler<I extends DIDLObject> extends SAXParser.Handler<I> {
        ...
        public void endElement(String uri, String localName, String qName) throws SAXException {
            ...
            if (DIDLObject.Property.DC.NAMESPACE.URI.equals(uri)) {
                ...
                if (PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_DESCRIPTION.equals(localName)) {
                ...
                if (SpeechConstant.LANGUAGE.equals(localName)) {
    ...
    public class ContainerHandler extends DIDLObjectHandler<Container> {
        ...
        @Override // org.teleal.cling.support.contentdirectory.DIDLParser.DIDLObjectHandler
        public void endElement(String uri, String localName, String qName) throws SAXException {
            super.endElement(uri, localName, qName);
            if (DIDLObject.Property.UPNP.NAMESPACE.URI.equals(uri)) {
