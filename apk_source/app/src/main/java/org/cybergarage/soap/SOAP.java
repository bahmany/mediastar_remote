...
public class SOAP {
    ...
    public static final Node createEnvelopeBodyNode() {
        ...
        envNode.setAttribute("xmlns:s", "http://schemas.xmlsoap.org/soap/envelope/");
        envNode.setAttribute("s:encodingStyle", "http://schemas.xmlsoap.org/soap/encoding/");
        Node bodyNode = new Node("s:Body");
