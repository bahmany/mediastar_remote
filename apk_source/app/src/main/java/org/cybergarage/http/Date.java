...
public class Date {
    ...
    public String getDateString() {
        ...
        return String.valueOf(toWeekString(cal.get(7))) + ", " + toTimeString(cal.get(5)) + " " + toMonthString(cal.get(2)) + " " + Integer.toString(cal.get(1)) + " " + toTimeString(cal.get(11)) + ":" + toTimeString(cal.get(12)) + ":" + toTimeString(cal.get(13)) + " GMT";
    }

    public String getTimeString() {
        Calendar cal = getCalendar();
        return String.valueOf(toDateString(cal.get(11))) + (cal.get(13) % 2 == 0 ? ":" : " ") + toDateString(cal.get(12));
    }
}
