...
public class NTLMUtilities implements NTLMConstants {
    ...
    public static final byte[] getOsVersion() throws Exception {
        String line;
    ...
    public static final byte[] createType1Message(String workStation, String domain, Integer customFlags, byte[] osVersion) throws IOException {
    ...
    public static final byte[] createType3Message(String user, String password, byte[] challenge, String target, String workstation, Integer serverFlags, byte[] osVersion) throws IOException {
