...
public class Base64 {
    ...
    public static byte[] encodeBase64(byte[] binaryData, boolean isChunked) {
        ...
        while (i < numberTriplets) {
            ...
            byte l = (byte) (b2 & 15);
            byte k = (byte) (b1 & 3);
            byte val1 = (b1 & Byte.MIN_VALUE) == 0 ? (byte) (b1 >> 2) : (byte) ((b1 >> 2) ^ Opcodes.CHECKCAST);
        ...
        if (fewerThan24bits == 8) {
            ...
            byte k2 = (byte) (b12 & 3);
            byte val12 = (b12 & Byte.MIN_VALUE) == 0 ? (byte) (b12 >> 2) : (byte) ((b12 >> 2) ^ Opcodes.CHECKCAST);
            ...
            byte l2 = (byte) (b22 & 15);
            byte k3 = (byte) (b13 & 3);
            byte val13 = (b13 & Byte.MIN_VALUE) == 0 ? (byte) (b13 >> 2) : (byte) ((b13 >> 2) ^ Opcodes.CHECKCAST);
