...
public class Socks4LogicHandler extends AbstractSocksLogicHandler {
    ...
    public void doHandshake(IoFilter.NextFilter nextFilter) throws UnsupportedEncodingException {
        logger.debug(" doHandshake()");
        writeRequest(nextFilter, this.request);
    }

    protected void writeRequest(IoFilter.NextFilter nextFilter, SocksProxyRequest request) throws UnsupportedEncodingException {
        try {
