...
public class GlobalConstantValue {
    ...
    public static final int GMS_MSG_SPE_DO_MAX = 1400;
    public static final int GMS_MSG_SPE_DO_SET_REF = 1305;
    public static final int GMS_MSG_SPE_DO_SET_SPAN_AND_CENT_FRE = 1301;
    public static final int GMS_MSG_SPE_DO_SET_STATE_22K = 1303;
    public static final int GMS_MSG_SPE_DO_SET_STATE_DISEQC = 1304;
    public static final int GMS_MSG_SPE_DO_SET_STATE_VH = 1302;
    public static final int GMS_MSG_SPE_REQUEST_MAX = 400;
    public static final int GMS_MSG_SPE_REQUEST_SPECTRUM_INFO = 301;
    public static final int GMS_MSG_SPE_REQUEST_SPECTRUM_SETTING = 302;
    ...
    public static final int STRUCT_SPECTRUM_INFO = 28;
    public static final int STRUCT_SPECTRUM_SETTING = 29;
