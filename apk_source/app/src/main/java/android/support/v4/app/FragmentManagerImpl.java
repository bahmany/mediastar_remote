...
final class FragmentManagerImpl extends FragmentManager {
    ...
    public void popBackStack(String name, int flags) {
        enqueueAction(new Runnable() { // from class: android.support.v4.app.FragmentManagerImpl.3
            ...
            AnonymousClass3(String name2, int flags2) {
                str = name2;
                i = flags2;
            }
    ...
    public void popBackStack(int id, int flags) {
        ...
        enqueueAction(new Runnable() { // from class: android.support.v4.app.FragmentManagerImpl.4
            ...
            AnonymousClass4(int id2, int flags2) {
                i = id2;
                i = flags2;
            }
            ...
            @Override // java.lang.Runnable
            public void run() {
                FragmentManagerImpl.this.popBackStackState(FragmentManagerImpl.this.mActivity.mHandler, null, i, i);
            }
        }, false);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:329:0x02c4  */
