...
public class FragmentActivity extends Activity {
    ...
    class AnonymousClass2 implements FragmentContainer {
        AnonymousClass2() {
        }
    ...
    /* JADX WARN: Failed to find 'out' block for switch in B:104:0x00ed. Please report as an issue. */
            ...
            if (id != 0 && r != null) {
                switch ((-16777216) & id) {
                    case 16777216:
                        ...
                        out.append(":");
                        out.append(typename);
                        out.append(ServiceReference.DELIMITER);
