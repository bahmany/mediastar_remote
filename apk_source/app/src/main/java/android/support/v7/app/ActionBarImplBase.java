...
class ActionBarImplBase extends ActionBar {
    ...
    void showForActionMode() throws Resources.NotFoundException {
    ...
    void hideForActionMode() throws Resources.NotFoundException {
        if (this.mShowingForMode) {
    ...
    public ActionMode startActionMode(ActionMode.Callback callback) throws Resources.NotFoundException {
    ...
    void animateToMode(boolean toActionMode) throws Resources.NotFoundException {
        if (toActionMode) {
            showForActionMode();
        } else {
            hideForActionMode();
    ...
    class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        @Override // android.support.v7.view.ActionMode
        public void finish() throws Resources.NotFoundException {
    ...
    private void updateVisibility(boolean fromSystem) throws Resources.NotFoundException {
    ...
    public void doShow(boolean fromSystem) throws Resources.NotFoundException {
        this.mTopVisibilityView.clearAnimation();
    ...
    public void doHide(boolean fromSystem) throws Resources.NotFoundException {
        this.mTopVisibilityView.clearAnimation();
