...
class ActionBarActivityDelegateBase extends ActionBarActivityDelegate implements MenuPresenter.Callback, MenuBuilder.Callback {
    ...
    public ActionBar createSupportActionBar() throws Resources.NotFoundException {
        ensureSubDecor();
    ...
    @Override // android.support.v7.app.ActionBarActivityDelegate
    public void setContentView(View v) throws Resources.NotFoundException {
        ensureSubDecor();
        ViewGroup contentParent = (ViewGroup) this.mActivity.findViewById(android.R.id.content);
    ...
    @Override // android.support.v7.app.ActionBarActivityDelegate
    public void setContentView(int resId) throws Resources.NotFoundException {
        ensureSubDecor();
        ViewGroup contentParent = (ViewGroup) this.mActivity.findViewById(android.R.id.content);
        contentParent.removeAllViews();
    ...
    @Override // android.support.v7.app.ActionBarActivityDelegate
    public void setContentView(View v, ViewGroup.LayoutParams lp) throws Resources.NotFoundException {
        ensureSubDecor();
        ViewGroup contentParent = (ViewGroup) this.mActivity.findViewById(android.R.id.content);
        contentParent.removeAllViews();
    ...
    @Override // android.support.v7.app.ActionBarActivityDelegate
    public void addContentView(View v, ViewGroup.LayoutParams lp) throws Resources.NotFoundException {
        ensureSubDecor();
        ViewGroup contentParent = (ViewGroup) this.mActivity.findViewById(android.R.id.content);
        contentParent.addView(v, lp);
        this.mActivity.onSupportContentChanged();
    ...
    final void ensureSubDecor() throws Resources.NotFoundException {
        ...
        if (!this.mSubDecorInstalled) {
            ...
            View content = this.mActivity.findViewById(android.R.id.content);
            content.setId(-1);
