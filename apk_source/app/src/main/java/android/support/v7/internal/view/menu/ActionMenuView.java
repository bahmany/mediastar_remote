...
public class ActionMenuView extends LinearLayoutICS implements MenuBuilder.ItemInvoker, MenuView {
    ...
    public ActionMenuView(Context context, AttributeSet attrs) {
        ...
        this.mMaxItemHeight = a.getDimensionPixelSize(1, 0);
        a.recycle();
    }
    ...
    private void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int itemHeightSpec = heightMode == 1073741824 ? View.MeasureSpec.makeMeasureSpec(heightSize - heightPadding, 1073741824) : View.MeasureSpec.makeMeasureSpec(Math.min(this.mMaxItemHeight, heightSize - heightPadding), Integer.MIN_VALUE);
