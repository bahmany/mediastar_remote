...
public abstract class ActionBar {
    ...
    @IntDef(flag = BuildConfig.DEBUG, value = {MediaStatus.COMMAND_PAUSE, MediaStatus.COMMAND_SEEK, MediaStatus.COMMAND_SET_VOLUME, MediaStatus.COMMAND_TOGGLE_MUTE, MediaStatus.COMMAND_SKIP_FORWARD})
    ...
    public abstract void setSubtitle(@Nullable CharSequence charSequence);
