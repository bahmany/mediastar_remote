...
public class ActionBarView extends AbsActionBarView {
    ...
    class AnonymousClass1 implements AdapterViewICS.OnItemSelectedListener {
        AnonymousClass1() {
        }
    ...
    public ActionBarView(Context context, AttributeSet attrs) {
        ...
        int homeResId = a.getResourceId(14, R.layout.abc_action_bar_home);
    ...
    public void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            ...
            this.mTitleLayout = (LinearLayout) inflater.inflate(R.layout.abc_action_bar_title_item, (ViewGroup) this, false);
            ...
            view.setVisibility(i);
            this.mTitleLayout.setEnabled(homeAsUp && !showHome);
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (customView != null) {
            ...
            int customNavHeightMode = (this.mContentHeight > 0 && lp2.height != -2) ? 1073741824 : Integer.MIN_VALUE;
            if (lp2.height >= 0) {
            ...
            int customNavWidth = Math.max(0, (lp2.width >= 0 ? Math.min(lp2.width, availableWidth) : availableWidth) - horizontalMargin);
            int hgrav = (ablp != null ? ablp.gravity : 19) & 7;
            if (hgrav == 1 && lp2.width == -1) {
        ...
        if (this.mExpandedActionView == null && showTitle) {
            measureChildView(this.mTitleLayout, availableWidth, View.MeasureSpec.makeMeasureSpec(this.mContentHeight, 1073741824), 0);
    ...
    public void onRestoreInstanceState(Parcelable p) {
        SupportMenuItem item;
        SavedState state = (SavedState) p;
        super.onRestoreInstanceState(state.getSuperState());
        if (state.expandedMenuItemId != 0 && this.mExpandedMenuPresenter != null && this.mOptionsMenu != null && (item = (SupportMenuItem) this.mOptionsMenu.findItem(state.expandedMenuItemId)) != null) {
            ...
            if (this.mCurrentExpandedItem != null) {
                ...
                if (this.mMenu != null) {
                    ...
                    while (true) {
                        ...
                        SupportMenuItem item = (SupportMenuItem) this.mMenu.getItem(i);
