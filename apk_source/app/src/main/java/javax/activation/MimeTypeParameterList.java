        ...
        if (parameterList != null && (length = parameterList.length()) > 0) {
            ...
            while (i < length && parameterList.charAt(i) == ';') {
                ...
                if (i2 < length) {
                    ...
                    String name = parameterList.substring(i2, i2).toLowerCase(Locale.ENGLISH);
                    ...
                    char c = parameterList.charAt(i4);
                    if (c == '\"') {
                        int i5 = i4 + 1;
                        if (i5 >= length) {
                        ...
                        value = unquote(parameterList.substring(i5, i5));
                        i4 = i5 + 1;
                    } else if (isTokenChar(c)) {
                        while (i4 < length && isTokenChar(parameterList.charAt(i4))) {
                            i4++;
                        }
                        value = parameterList.substring(i4, i4);
                    } else {
