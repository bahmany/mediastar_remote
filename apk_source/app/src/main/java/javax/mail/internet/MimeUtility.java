...
public class MimeUtility {
    ...
    static {
        ...
        mime2java.put(XML.CHARSET_UTF8, "UTF8");
    ...
    public static String getEncoding(DataSource ds) throws IOException {
        String encoding;
        try {
    ...
    public static String decodeText(String etext) throws IOException {
        String word;
        if (etext.indexOf("=?") != -1) {
    ...
    private static String encodeWord(String string, String charset, String encoding, boolean encodingWord) throws IOException {
        String jcharset;
        boolean b64;
    ...
    private static void doEncode(String string, boolean b64, String jcharset, int avail, String prefix, boolean first, boolean encodingWord, StringBuffer buf) throws IOException {
        int len;
        OutputStream eos;
    ...
    public static String decodeWord(String eword) throws ParseException, IOException {
        String decodedWord;
        InputStream is;
        if (!eword.startsWith("=?")) {
        ...
        try {
            if (word.length() > 0) {
                ...
                decodedWord = count2 <= 0 ? "" : new String(bytes, 0, count2, charset);
            } else {
                decodedWord = "";
            }
    ...
    private static String decodeInnerWords(String word) throws IOException {
        int end;
        int end2;
        int start = 0;
    ...
    public static String javaCharset(String charset) {
        String alias;
        return (mime2java == null || charset == null || (alias = (String) mime2java.get(charset.toLowerCase(Locale.ENGLISH))) == null) ? charset : alias;
    }

    public static String mimeCharset(String charset) {
        String alias;
        return (java2mime == null || charset == null || (alias = (String) java2mime.get(charset.toLowerCase(Locale.ENGLISH))) == null) ? charset : alias;
    }
    ...
    public static String getDefaultJavaCharset() {
        if (defaultJavaCharset == null) {
            ...
            try {
                ...
                InputStreamReader reader = new InputStreamReader(new InputStream() { // from class: javax.mail.internet.MimeUtility.1NullInputStream
                    C1NullInputStream() {
                    }
    ...
    /* renamed from: javax.mail.internet.MimeUtility$1NullInputStream */
    ...
    static int checkAscii(InputStream is, int max, boolean breakOnNonAscii) throws IOException {
        int ascii = 0;
        int non_ascii = 0;
        int block = 4096;
        int linelen = 0;
